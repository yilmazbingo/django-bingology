...
class Product(models.Model):
    ...
    # blank=True means a form blank for name field is OK
    name=models.CharField(max_length=200,null=True,blank=True)
    # in order to use Image as field, install pillow
...
class OrderItem(models.Model):
    ...
    def __str__(self):
        # since name is already set to be string, we dont have to str()
